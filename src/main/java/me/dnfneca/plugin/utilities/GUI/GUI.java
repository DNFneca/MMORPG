...
public enum GUI {
	...
	public static void MainMenu(final Player p) {
		...
		final Inventory inv = Bukkit.createInventory(null, 54, "Main Menu");
...
//        inv.addItem(clay);
	...
	public static void StatsMenu(final Player player) {
		final Inventory inv = Bukkit.createInventory(null, 54, "Stats");
...
//        inv.addItem(clay);
	...
	public static void ChooseClassesMenu(final Player p) {
		...
		final Inventory inv = Bukkit.createInventory(null, 27, "Choose a Class");
	...
	public static void areYouSureClassMenu(final Player p) {
		...
		final Inventory inv = Bukkit.createInventory(null, 27, "Are you sure. Confirm your class");
